      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <a
            ...
            className="text-xs font-mono text-[#9E9EA8] hover:text-white transition-colors hidden sm:block px-3 py-2"
          >
            Log in
          </a>
          ...
          <MagneticButton
            ...
            className="bg-[#FF5733] hover:bg-[#FF4520] text-black text-xs font-bold font-mono px-4 py-2.5 rounded-xl transition-all shadow-[0_0_20px_rgba(255,87,51,0.25)] flex items-center space-x-1.5"
          >
