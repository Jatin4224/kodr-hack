    ...
    <section className="py-32 bg-[#0A0A0C] border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        <Reveal delay={0.2} className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <MagneticButton className="bg-[#FF5733] hover:bg-[#FF4520] text-black font-extrabold text-base px-8 py-4 rounded-xl transition-all shadow-[0_0_40px_rgba(255,87,51,0.3)] hover:shadow-[0_0_60px_rgba(255,87,51,0.5)] active:scale-95 flex items-center space-x-2 group">
