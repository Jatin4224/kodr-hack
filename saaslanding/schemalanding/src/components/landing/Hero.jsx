      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <Reveal delay={0.3} className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <MagneticButton className="bg-[#FF5733] hover:bg-[#FF4520] text-black font-extrabold px-8 py-4 rounded-xl text-sm transition-all shadow-[0_0_35px_-5px_rgba(255,87,51,0.5)] hover:shadow-[0_0_50px_-5px_rgba(255,87,51,0.7)]">
